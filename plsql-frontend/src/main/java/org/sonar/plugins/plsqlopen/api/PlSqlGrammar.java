...
public enum PlSqlGrammar implements GrammarRuleKey {
    ...
    public static LexerfulGrammarBuilder create(PlSqlConfiguration conf) {
        ...
        if (conf.isErrorRecoveryEnabled()) {
            ...
            b.rule(FILE_INPUT).is(b.zeroOrMore(b.firstOf(
                    VALID_INPUT,
                    RECOVERY)), EOF);
        } else {
            b.rule(RECOVERY).is(b.nothing());
            b.rule(FILE_INPUT).is(b.zeroOrMore(VALID_INPUT), EOF);
        }
    ...
    private static void createLiterals(LexerfulGrammarBuilder b) {
        ...
        b.rule(LITERAL).is(b.firstOf(NULL_LITERAL, BOOLEAN_LITERAL, NUMERIC_LITERAL, b.sequence(b.optional(DATE),CHARACTER_LITERAL), DATE_LITERAL, INTERVAL_LITERAL, INQUIRY_DIRECTIVE));
    }
    ...
    private static void createStatements(LexerfulGrammarBuilder b) {
        ...
        b.rule(INSERT_STATEMENT).is(b.optional(LABEL), b.optional(FORALL_STATEMENT), b.firstOf(INSERT_EXPRESSION,INSERT_ALL_EXPRESSION), SEMICOLON);
    ...
    private static void createExpressions(LexerfulGrammarBuilder b) {
		...
		b.rule(SUBSTITUTION_VARIABLE).is(b.firstOf(
			b.sequence(DOUBLEPARAM,b.firstOf(IDENTIFIER_NAME, INTEGER_LITERAL)),
			b.sequence(PARAM,b.firstOf(IDENTIFIER_NAME, INTEGER_LITERAL))));
        
        b.rule(VARIABLE_NAME).is(b.firstOf(IDENTIFIER_NAME, SUBSTITUTION_VARIABLE,HOST_AND_INDICATOR_VARIABLE));
        
        b.rule(PRIMARY_EXPRESSION).is(
                b.firstOf(LITERAL, VARIABLE_NAME,SET, SQL, MULTIPLICATION)).skip();
        ...
        b.rule(MEMBER_EXPRESSION).is(
                ...
                b.zeroOrMore( b.firstOf(
                        b.sequence(b.firstOf(MOD, REMOTE),b.nextNot(ROWTYPE),b.nextNot(TYPE)),
						DOT
						),
                        b.firstOf(
								SUBSTITUTION_VARIABLE,
        ...
        b.rule(ARGUMENT).is(b.optional(IDENTIFIER_NAME, ASSOCIATION), b.optional(b.firstOf(DISTINCT,UNIQUE)), EXPRESSION);
    ...
    private static void createDeclarations(LexerfulGrammarBuilder b) {
        b.rule(DEFAULT_VALUE_ASSIGNMENT).is(b.firstOf(ASSIGNMENT, DEFAULT),b.firstOf(EXPRESSION,b.sequence(PARAM,INTEGER_LITERAL)));
     ...
     // http://docs.oracle.com/cd/B28359_01/appdev.111/b28370/procedure.htm
        ...
        b.rule(PROCEDURE_DECLARATION).is(
                ...
                b.optional(b.firstOf(
                        SEMICOLON,
                        b.sequence(b.firstOf(IS, AS), b.firstOf(
