...
import static org.sonar.plugins.plsqlopen.api.PlSqlGrammar.ADDITIVE_EXPRESSION;
...
import static org.sonar.plugins.plsqlopen.api.PlSqlGrammar.UNIT_NAME;
import static org.sonar.plugins.plsqlopen.api.PlSqlGrammar.SUBSTITUTION_VARIABLE;
...
import static org.sonar.plugins.plsqlopen.api.PlSqlKeyword.SHARE;
import static org.sonar.plugins.plsqlopen.api.PlSqlKeyword.ROW;
import static org.sonar.plugins.plsqlopen.api.PlSqlKeyword.LOCK;
import static org.sonar.plugins.plsqlopen.api.PlSqlKeyword.TABLE;
import static org.sonar.plugins.plsqlopen.api.PlSqlKeyword.EXCLUSIVE;
...
import static org.sonar.plugins.plsqlopen.api.PlSqlKeyword.CASE;
...
import static org.sonar.plugins.plsqlopen.api.PlSqlKeyword.MODE;
...
import static org.sonar.plugins.plsqlopen.api.PlSqlKeyword.IN;
...
import static org.sonar.plugins.plsqlopen.api.PlSqlKeyword.ELSE;
...
public enum DmlGrammar implements GrammarRuleKey {
    ...
    INSERT_COLUMNS,
    INSERT_EXPRESSION,
	INSERT_ALL_EXPRESSION,
    MERGE_EXPRESSION,
    MERGE_UPDATE_CLAUSE,
    MERGE_INSERT_CLAUSE,
	LOCK_TABLE,
    DML_COMMAND, ERROR_LOGGING_CLAUSE, ROW_LIMITING_CLAUSE, OFFSET_CLAUSE, FETCH_ROW_CLAUSE;
    ...
    private static void createSelectExpression(LexerfulGrammarBuilder b) {
		...
		b.rule(LOCK_TABLE).is(
		LOCK,TABLE,UNIT_NAME,IN,b.firstOf(
			...
			SHARE,
			EXCLUSIVE
		),MODE,b.optional(b.firstOf(b.sequence(WAIT,INTEGER_LITERAL),NOWAIT)),b.optional(SEMICOLON));
        
        b.rule(TABLE_REFERENCE).is(
                b.optional(IDENTIFIER_NAME, DOT),
                IDENTIFIER_NAME,
                b.optional(REMOTE, b.firstOf(SUBSTITUTION_VARIABLE,IDENTIFIER_NAME), b.optional(DOT, IDENTIFIER_NAME)));
        ...
        b.rule(JOIN_CLAUSE).is(b.optional(b.sequence(DML_TABLE_EXPRESSION_CLAUSE, b.zeroOrMore(COMMA, DML_TABLE_EXPRESSION_CLAUSE))), b.oneOrMore(b.firstOf(INNER_CROSS_JOIN_CLAUSE, OUTER_JOIN_CLAUSE)));
        b.rule(SELECT_COLUMN).is(EXPRESSION, b.optional(b.optional(AS), b.firstOf(IDENTIFIER_NAME,CASE), b.nextNot(COLLECT)));
    ...
    private static void createDeleteExpression(LexerfulGrammarBuilder b) {
        b.rule(RETURNING_INTO_CLAUSE).is(
				...
				b.firstOf(
					b.optional(ADDITIVE_EXPRESSION, b.zeroOrMore(COMMA, OBJECT_REFERENCE)),
    ...
    private static void createInsertExpression(LexerfulGrammarBuilder b) {
        ...
        b.rule(INSERT_EXPRESSION).is(
		 ...
		 b.rule(INSERT_ALL_EXPRESSION).is(
                INSERT,ALL,b.oneOrMore(
				b.optional(WHEN,EXPRESSION,THEN),b.optional(ELSE),INTO, TABLE_REFERENCE, b.optional(IDENTIFIER_NAME),b.optional(INSERT_COLUMNS),
				b.optional(b.firstOf(
						b.sequence(VALUES, LPARENTHESIS, EXPRESSION, b.zeroOrMore(COMMA, EXPRESSION), RPARENTHESIS),
						b.sequence(VALUES, EXPRESSION)))),
				SELECT_EXPRESSION,
